  ...
  _createClass(EventPropagator, [{
    ...
    value: function startNewPropagationStep(componentId, event, key, type) {
      ...
      if (event.repeat && _Configuration["default"].option('ignoreRepeatedEventsWhenKeyHeldDown')) {
        this.logger.debug(this.logger.keyEventPrefix(componentId), "Ignored repeated ".concat((0, _describeKeyEvent["default"])(event, key, _KeyEventType["default"].keydown), " event."));
    ...
    get: function get() {
      ...
      return (0, _lazyLoadAttribute["default"])(this, '_previousPropagation', function () {
        return _this._clone({
          copyState: false
        });
      });
