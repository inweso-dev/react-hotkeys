...
var _ApplicationKeyMapBuilder = _interopRequireDefault(require("./definitions/ApplicationKeyMapBuilder"));
...
var KeyEventManager = /*#__PURE__*/function () {
  ...
  function KeyEventManager() {
    ...
    var logLevel = _Configuration["default"].option('logLevel');

    this.logger = configuration.logger || new _Logger["default"](logLevel);
    this.focusOnlyEventStrategy = new _FocusOnlyKeyEventStrategy["default"]({
      configuration: configuration,
      logLevel: logLevel
    }, this);
    this.globalEventStrategy = new _GlobalKeyEventStrategy["default"]({
      configuration: configuration,
      logLevel: logLevel
    }, this);
  ...
  _createClass(KeyEventManager, [{
    ...
    get: function get() {
      return [this.globalEventStrategy, this.focusOnlyEventStrategy].reduce(function (memo, strategy) {
        var builder = new _ApplicationKeyMapBuilder["default"](strategy.componentTree);
        var keyMap = builder.build();
        return _objectSpread(_objectSpread({}, memo), keyMap);
      }, {});
    }
    /********************************************************************************
    ...
    function getInstance() {
      var configuration = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      return (0, _lazyLoadAttribute["default"])(this, 'instance', function () {
