...
(function (global, factory) {
  ...
  var _configuration = _objectSpread2({}, _defaultConfiguration);
  /**
  ...
  function backwardsCompatibleContext(Component, _ref) {
    ...
    if (typeof React__default.createContext === 'undefined') {
      ...
      var context = /*#__PURE__*/React__default.createContext(contextType); // noinspection JSUndefinedPropertyAssignment
  ...
  var InvalidKeyNameError = /*#__PURE__*/function (_Error) {
    _inherits(InvalidKeyNameError, _Error);

    var _super = _createSuper(InvalidKeyNameError);
    ...
    function InvalidKeyNameError() {
      ...
      _defineProperty(_assertThisInitialized(_this), "name", 'InvalidKeyNameError');
    ...
    return Object.keys(keyCombination).reduce(function (allCombinations, keyName) {
      ...
      return keyAliasList.reduce(function (keyAliasCombinations, keyAlias) {
        return keyAliasCombinations.concat(allCombinations.map(function (keyDictionary) {
          return _objectSpread2(_objectSpread2({}, keyDictionary), {}, _defineProperty({}, keyAlias, true));
        }));
      }, []);
    }, []);
  }
  ...
  var KeyEventStateArrayManager = /*#__PURE__*/function () {
    ...
    _createClass(KeyEventStateArrayManager, null, [{
       ...
       */
      function newRecord(keyEventType, keyEventState) {
  ...
  var KeyCombinationDecorator = /*#__PURE__*/function () {
  ...
  var KeyCombinationIterator = /*#__PURE__*/function () {
  ...
  var ComponentTree = /*#__PURE__*/function (_Registry) {
    ...
    _createClass(ComponentTree, [{
      ...
      value: function update(componentId, keyMap) {
        ...
        _get(_getPrototypeOf(ComponentTree.prototype), "set", this).call(this, componentId, _objectSpread2(_objectSpread2({}, component), {}, {
          keyMap: keyMap
        }));
      }
      /**
  ...
  var ComponentOptionsList = /*#__PURE__*/function () {
    ...
    _createClass(ComponentOptionsList, [{
      ...
      value: function _addActionOptions(memo, componentId, actionName, keySequence, keyEventType) {
        ...
        memo[actionName].push(_objectSpread2({
  ...
  var KeyCombinationMatcher = /*#__PURE__*/function () {
    ...
    _createClass(KeyCombinationMatcher, [{
      ...
      value: function _addHandlerToActionConfig(id, _ref2) {
        ...
        this._setCombinationMatcher(id, _objectSpread2(_objectSpread2({}, combination), {}, {
          events: _objectSpread2(_objectSpread2({}, combination.events), {}, _defineProperty({}, keyEventType, {
            actionName: actionName,
            handler: handler
          }))
        }));
  ...
  var KeyEventCounter = /*#__PURE__*/function () {
  ...
  var AbstractKeyEventSimulator = /*#__PURE__*/function () {
    ...
    _createClass(AbstractKeyEventSimulator, [{
      ...
      value: function cloneAndMergeEvent(event, extra) {
        ...
        return _objectSpread2(_objectSpread2({}, eventAttributes), extra);
      }
    }, {
      key: "_shouldSimulate",
  ...
  var FocusOnlyKeyEventSimulator = /*#__PURE__*/function (_AbstractKeyEventSimu) {
    ...
    _createClass(FocusOnlyKeyEventSimulator, [{
      ...
      value: function handleKeyPressSimulation(options) {
        this._handleEventSimulation('keypressEventsToSimulate', 'simulatePendingKeyPressEvents', _objectSpread2({
      ...
      value: function handleKeyUpSimulation(options) {
        this._handleEventSimulation('keyupEventsToSimulate', 'simulatePendingKeyUpEvents', _objectSpread2({
  ...
  var FocusTree = /*#__PURE__*/function () {
    function FocusTree() {
  ...
  var EventStrategyLogger = /*#__PURE__*/function (_Logger) {
    _inherits(EventStrategyLogger, _Logger);

    var _super = _createSuper(EventStrategyLogger);
    ...
    function EventStrategyLogger(logLevel, eventStrategy) {
      ...
      _this = _super.call(this, logLevel);
    ...
    _createClass(EventStrategyLogger, [{
      ...
      value: function nonKeyEventPrefix(componentId) {
        var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        return this.keyEventPrefix(componentId, _objectSpread2(_objectSpread2({}, options), {}, {
          eventId: false
        }));
      }
    }, {
  ...
  var FocusOnlyKeyEventStrategy = /*#__PURE__*/function (_AbstractKeyEventStra) {
    ...
    var _super = _createSuper(FocusOnlyKeyEventStrategy);
    ...
    function FocusOnlyKeyEventStrategy() {
       ...
       ******************************************************************************/
      _this = _super.call(this, options, keyEventManager);
      _this.logger = new FocusOnlyLogger(options.logLevel || 'warn', _assertThisInitialized(_this));
      ...
      _this._simulator = new FocusOnlyKeyEventSimulator(_assertThisInitialized(_this));
      return _this;
    }
    /**
  ...
  var GlobalKeyEventSimulator = /*#__PURE__*/function (_AbstractKeyEventSimu) {
    _inherits(GlobalKeyEventSimulator, _AbstractKeyEventSimu);

    var _super = _createSuper(GlobalKeyEventSimulator);
    ...
    _createClass(GlobalKeyEventSimulator, [{
      key: "handleKeyPressSimulation",
      value: function handleKeyPressSimulation(options) {
        this._handleEventSimulation('handleKeyPress', _objectSpread2({
          eventType: KeyEventType.keypress
        }, options));
      }
    }, {
      key: "handleKeyUpSimulation",
      value: function handleKeyUpSimulation(options) {
        this._handleEventSimulation('handleKeyUp', _objectSpread2({
          eventType: KeyEventType.keyup
        }, options));
      }
    }, {
  ...
  var GlobalEventListenerAdaptor = /*#__PURE__*/function () {
  ...
  var GlobalKeyEventStrategy = /*#__PURE__*/function (_AbstractKeyEventStra) {
    ...
    var _super = _createSuper(GlobalKeyEventStrategy);
    ...
    function GlobalKeyEventStrategy() {
       ...
       */
      _this = _super.call(this, options, keyEventManager);
      _this.logger = new GlobalLogger(options.logLevel || 'warn', _assertThisInitialized(_this));
      /**
      ...
      _this._simulator = new GlobalKeyEventSimulator(_assertThisInitialized(_this));
      _this._listenerAdaptor = new GlobalEventListenerAdaptor(_assertThisInitialized(_this), {
        logger: _this.logger
      });
      return _this;
    }
  ...
  var ApplicationKeyMapBuilder = /*#__PURE__*/function () {
    ...
    _createClass(KeyEventManager, [{
      ...
      get: function get() {
        return [this.globalEventStrategy, this.focusOnlyEventStrategy].reduce(function (memo, strategy) {
          ...
          return _objectSpread2(_objectSpread2({}, memo), keyMap);
        }, {});
      }
      /********************************************************************************
       * Registering key maps
  ...
  var FocusOnlyComponentManager = /*#__PURE__*/function () {
    ...
    _createClass(FocusOnlyComponentManager, [{
      ...
      value: function _mergeWithOptions(key, props) {
        return _objectSpread2(_objectSpread2({}, this._hotKeysOptions[key] || {}), props[key] || {});
      }
    }, {
      key: "_getHandlers",
  ...
  var _excluded$1 = ["hotKeys", "innerRef", "component"];
  /**
   * @see HotKeysEnabled
   */

  var HotKeysWrapper = /*#__PURE__*/function (_Component) {
    _inherits(HotKeysWrapper, _Component);

    var _super = _createSuper(HotKeysWrapper);
    ...
    _createClass(HotKeysWrapper, [{
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            remainingProps = _objectWithoutProperties(_this$props, _excluded$1);

        var DefaultComponent = component || Configuration.option('defaultComponent');
        return /*#__PURE__*/React__default.createElement(DefaultComponent, _objectSpread2(_objectSpread2({}, hotKeys), {}, {
          ref: innerRef
        }, remainingProps));
      }
    }]);
  ...
  var GlobalComponentManager = /*#__PURE__*/function () {
  ...
  var GlobalHotKeys = /*#__PURE__*/function (_Component) {
    _inherits(GlobalHotKeys, _Component);

    var _super = _createSuper(GlobalHotKeys);
  ...
  var HotKeysIgnoreOverrideManager = /*#__PURE__*/function () {
  ...
  function overrideComponent(displayName) {
    ...
    return _temp = _class = /*#__PURE__*/function (_Component) {
      ...
      var _super = _createSuper(OverrideComponent);
      ...
      _createClass(OverrideComponent, [{
        ...
        value: function render() {
          var _this$props = this.props,
              hotKeys = _this$props.hotKeys,
              remainingProps = _objectWithoutProperties(_this$props, _excluded$3);

          var DefaultComponent = remainingProps.component || Configuration.option('defaultComponent');
          return /*#__PURE__*/React__default.createElement(DefaultComponent, _objectSpread2(_objectSpread2({}, hotKeys), remainingProps));
        }
      }]);
